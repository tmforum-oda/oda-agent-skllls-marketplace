...
Look up the id in `${CLAUDE_PLUGIN_ROOT}/knowledge/index/components.json`. If the id isn't in the
...
`${CLAUDE_PLUGIN_ROOT}/knowledge/components/{TMFCxxx}/component.yaml` directly and split it into
