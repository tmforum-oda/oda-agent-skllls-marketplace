...
This plugin bundles 15 Agent Skills. Claude Code invokes one automatically when your request matches what it does -- you don't need to name the skill directly, just describe what you want.
