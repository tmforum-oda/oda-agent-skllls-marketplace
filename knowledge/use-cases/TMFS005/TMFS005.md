...
| Oda-Component | The current version of theTMFC001 Product Catalog Management does not expose the sub-resource ProductUsageSpecification from TMF767 ->decision to be made to determine whether productUsageSpecification remains in TMF767 or will move to TMF620  AP-4783 - Move/rename UsageSpecification from TMF635 Usage Management to TMF620 Product Catalog  backlog <br>![](media/image12.png) |
